                ...
                @if(auth()->user()->hasPermission('exams-read'))
                        <div class=" col-4">
                            <div class="small-box bg-dark text-center">
                                ...
                                <a href="{{route('exams.index')}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                    @endif
                ...
                @if(auth()->user()->hasPermission('printRequests-read'))
                        <div class=" col-4">
                            <div class="small-box bg-dark text-center">
                                ...
                                <a href="{{route('requests.books.index')}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                    @endif
