                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                ...
                                @endif
                                <a  href="{{ route('admins.export', ['excel', ...request()->query()]) }}" class="btn  btn-success">@lang('dashboard.Excel Export')</a>
                                <a  href="{{ route('admins.export', ['pdf', ...request()->query()]) }}" class="btn  btn-danger">@lang('dashboard.PDF Export')</a>
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="operations-btns" style="">
                                                <a href="{{ route('admins.show', $manager->id) }}" class="btn  btn-dark">@lang('dashboard.Show')</a>
                                                @if(auth()->user()->hasPermission('admins-update'))
                                                    <a href="{{ route('admins.edit', $manager->id) }}" class="btn  btn-dark">@lang('dashboard.Edit')</a>
                                                @endif
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content float-left">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form action="{{route('admins.destroy' , $manager['id'])}}" method="post">
                                                                        @csrf
                                                                        {{method_field('DELETE')}}
