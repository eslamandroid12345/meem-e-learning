                                    ...
                                    <div class="row">
                                        <div class="form-group col-12">
                                            <label for="exampleInputName1"> @lang('dashboard.thereply')</label>
                                                <!-- <textarea name="content" class="form-control" id="summernote3" required></textarea> -->
                                                <textarea required name="content" rows="3" class="form-control" id="summernote" placeholder=""></textarea>
                                        </div>
                                    </div>
