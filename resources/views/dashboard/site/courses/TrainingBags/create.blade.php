    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card p-1">
                        <form action="{{route('bags.store')}}" method="post" autocomplete="off" enctype="multipart/form-data">
                            <div class="card-header">
                                <h3 class="card-title">{{__('titles.Create') . " " . __('titles.TrainingBag')}}</h3>
                            </div>
                            <div class="card-body">
                                @csrf
                                <div class="row" id="content">
                                    <div class="form-group col-6">
                                        ...
                                        <input value=""  name="name_ar" type="text" class="form-control" id="exampleInputName1" placeholder="">
                                    </div>

                                    <div class="form-group col-6">
                                        <label class="ml-3 mr-3" for="exampleInputName1">@lang('dashboard.Name') @lang('dashboard.en')</label>
                                        <input value=""  name="name_en" type="text" class="form-control" id="exampleInputName1" placeholder="">
                                    </div>

                                    <div class="form-group col-6">
                                        <label class="ml-3 mr-3" for="summernote">@lang('dashboard.Description') @lang('dashboard.ar')</label>
                                        <textarea id="summernote" class="form-control" name="description_ar">{{old('books.0.description_ar')}}</textarea>
                                    </div>

                                    <div class="form-group col-6">
                                        <label class="ml-3 mr-3" for="summernote1">@lang('dashboard.Description') @lang('dashboard.en')</label>
                                        <textarea id="summernote1" class="form-control" name="description_en">{{old('books.0.description_en')}}</textarea>
                                    </div>

                                    <div class="form-group col-6">
                                        <label class="ml-3 mr-3" for="exampleInputName1">@lang('dashboard.price')</label>
                                        <input value=""  name="price" type="number" class="form-control" id="exampleInputName1" placeholder="">
                                    </div>
                                    ...
                                    <div class="form-group clearfix col-6">
                                        <div class="icheck-wetasphalt d-inline">
                                            <input name="is_printable" type="checkbox" id="checkboxPrimary3" checked="">
