    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('course_bank_questions.store',$course->id) }}" method="post" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-12">
                                        ...
                                        <textarea name="content" type="text" class="form-control" id="summernote">{{ old('question.content') }}   </textarea>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="form-group clearfix col-12">
                                    <div class="icheck-wetasphalt d-inline">
                                        <input name="is_active" type="checkbox" value="1" id="checkboxPrimary3" @checked(old('is_active') == 'on')>
